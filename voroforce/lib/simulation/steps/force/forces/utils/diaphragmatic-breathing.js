 ...
 *
 * @param {number} t - Input between 0 and 1 representing progress through the breathing cycle
 ...
 */
export function diaphragmaticBreathing(t, options = {}) {
    ...
    const {
        ...
        variationAmount = 0.55, // Amount of natural variation (0-1)
    ...
    const variableInhaleRatio = inhaleRatio * (1 + phaseVariation * 0.1 * variationAmount);
    const variableExhaleRatio = exhaleRatio * (1 - phaseVariation * 0.1 * variationAmount);
