...
void calcMediaBbox(in uint index, inout vec4 mediaBbox, in vec2 cellCoords, in float bulgeFactor, in float edgeStepStart) {
...
//    float borderSmoothness = BORDER_SMOOTHNESS_BASE * borderSmoothnessScale * resolutionScale;
    ...
    #if MEDIA_ENABLED == 1
        calcMediaBbox(index, mediaBbox, cellCoords, bulgeFactor, edgeStepStart);
    #endif
